...
def get_chroma_collection():
    ...
    # Modèle d'embedding recommandé dans la roadmwaap (performant pour le multilingue FR/EN/AR)
...
def store_chunks_in_db(chunks, session_id: str, progress_callback=None):
    ...
    metadatas = [{"source": chunk['source'], "session_id": session_id} for chunk in chunks]
    # Création d'un ID unique pour chaque chunk (ex: "session_id_mon_cours.pdf_0")
...
def retrieve_context(query_text, session_id: str, n_results=4):
    """
